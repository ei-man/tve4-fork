...
function _ScoreboardUpdater_UpdatePlayerPanel(scoreboardConfig, playersContainer, playerId, localPlayerTeamId) {
    ...
    if (playerInfo) {
        ...
        var goldValue = (_a = scoreboardUi === null || scoreboardUi === void 0 ? void 0 : scoreboardUi.playerGold) === null || _a === void 0 ? void 0 : _a[playerId];
        var lumberValue = (_b = scoreboardUi === null || scoreboardUi === void 0 ? void 0 : scoreboardUi.playerLumber) === null || _b === void 0 ? void 0 : _b[playerId];
        ...
        if (scoreboardUi && scoreboardUi.scoreboardAchievements) {
            var achivementInfo = scoreboardUi.scoreboardAchievements[playerId];
            ...
            if (achievementIconPanel && achievementPanel) {
                if (achivementInfo && achivementInfo.icon) {
                    ...
                    if (achievementCounter) {
                        achievementCounter.text = (_c = achivementInfo.counter) !== null && _c !== void 0 ? _c : "";
        ...
        if (playerPortrait) {
            ...
            if (playerInfo.player_selected_hero !== "") {
                ...
                var player_table = CustomNetTables.GetTableValue("Shop", playerId);
