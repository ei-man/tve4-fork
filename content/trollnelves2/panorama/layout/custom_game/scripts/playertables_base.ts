...
(function(){
  ...
  GameEvents.SubscribeProtected( "pt_fu", TableFullUpdate);
  GameEvents.SubscribeProtected( "pt_uk", UpdateTable);
  GameEvents.SubscribeProtected( "pt_kd", DeleteTableKeys);
})();