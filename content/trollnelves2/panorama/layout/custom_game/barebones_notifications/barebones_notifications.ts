...
(function () {
  GameEvents.SubscribeProtected( "top_notification", TopNotification );
  GameEvents.SubscribeProtected( "bottom_notification", BottomNotification );
  GameEvents.SubscribeProtected( "top_remove_notification", TopRemoveNotification );
  GameEvents.SubscribeProtected( "bottom_remove_notification", BottomRemoveNotification );
})();
