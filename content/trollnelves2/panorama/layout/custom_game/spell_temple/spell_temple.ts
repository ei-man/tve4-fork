...
function SpellTemple_CreateSpell(info) 
{
    ...
    const SpellShopSpellBorder = $.CreatePanel("Panel", SpellShopSpellPanel, "");
...
function SpellTemple_UpdatePreviewSpellInf(info)
{
    ...
    const SpellShopPreviewEffect = $.CreatePanel("Panel", SpellShopPreviewIcon, "");
    ...
    SpellShopSpellPanelIcon.style.backgroundImage = 'url("file://{images}/custom_game/spell_shop/spell_icons/' + SpellTemple_GetSpellTexture(info[1], SpellTemple_GetPlayerSpellLevel(info[1], true)) + '.png")';
    SpellShopSpellPanelIcon.style.backgroundSize = "100%";
    const SpellShopSpellBorder = $.CreatePanel("Panel", SpellShopPreviewIcon, "");
    SpellShopSpellBorder.AddClass("SpellShopSpellBorder");
    ...
    const SpellPreviewPanelButtonActivate = $.CreatePanel("Panel", SpellPreviewPanelNameButton, "");
    ...
    const spell_cost = CustomNetTables.GetTableValue("game_spells_lib", "spell_cost");
    const player_table_coins = CustomNetTables.GetTableValue("Shop", Players.GetLocalPlayer())["0"]["1"];
    ...
    for (let i = 0; i <= Object.keys(info[4]).length; i++)
    {
        if (info[4][i])
        {
            const SpellPreviewLevelLabel = $.CreatePanel("Label", $("#PreviewSpellInfo"), "");
            ...
            const SpellPreviewLevelLabelDesc = $.CreatePanel("Label", $("#PreviewSpellInfo"), "");
...
function SpellTemple_UpgradeSpell(info)
{
    ...
    const nextLvl = SpellTemple_GetPlayerSpellLevel(info[1]) + 1;
    const cost = SpellTemple_GetSpellCost(info[1], nextLvl);
...
function SpellTemple_SpellDropNotification(data)
{
    ...
    const panel_spell_drop_label_header = $.CreatePanel("Label", panel_spell_drop, "");
    ...
    const SpellShopSpellPanel = $.CreatePanel("Panel", panel_spell_drop, "");
    ...
    const panel_label_spell_name_drop = $.CreatePanel("Label", panel_spell_drop, "");
    ...
    const SpellShopButtonDropClose = $.CreatePanel("Panel", panel_spell_drop, "");
