...
function ItemTooltipShow(panel, item_name) {
    panel.SetPanelEvent("onmouseover", () => {
        $.DispatchEvent("UIShowCustomLayoutParametersTooltip", panel, "shop_tooltip", "file://{resources}/layout/custom_game/donate_shop/shop_tooltip.xml", "item_name=" + item_name);
    });
